...
public class ExtractContent {
    ...
    public Map<String, Map<String, Object>> matchRegex(byte[] content, List<String> headers, byte[] body, String scopeString, String host) {
                ...
                if (loaded && (scope.contains(scopeString) || "any".equals(scope))) {
                    switch (scope) {
                        ...
                        case "response body":
                            ...
                            break;
                        case "request url":
                            matchContent = urlString.indexOf("?") > 0 ? urlString.substring(0, urlString.indexOf("?")) : urlString;
                            break;
                        case "request parameter":
                            matchContent = urlString.indexOf("?") > 0 ? urlString.substring(urlString.indexOf("?") + 1) : "";
                            break;
                        default:
                            break;
                    }
